...
{
    public:
        Vector3f v0, v1, v2;    //顶点A，B，C，逆时针顺序
        Vector3f e1, e2;        //两条边：v1-v0，v2-v0
        Vector3f t0, t1, t2;    //纹理坐标
        Vector3f normal;        //三角形的法向量
        float area;             //三角形的面积
        Material* m;            //材质
...
class MeshTriangle : public Object
{
    ...
    public:
        ...
        uint32_t numTriangles;                      //三角形的数目
        std::unique_ptr<uint32_t[]> vertexIndex;    //顶点索引
        std::unique_ptr<Vector2f[]> stCoordinates;  //纹理数组
